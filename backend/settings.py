...
SIMPLE_JWT = {
    ...
    'base.views.MyTokenObtainPairSerializer',
...
STORAGES = {
    'default': {
        ...
        'OPTIONS': {
            # Specify any additional options for the storage backend if needed
        },
    },
    'staticfiles': {
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000', 'https://ecommerce-tutorial-frontend.vercel.app/'
]
